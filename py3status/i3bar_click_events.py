...
class Py3status:
    ...
    def __init__(self):
        ...
        self.actions = {
            "wireless enp8s0": {
                1: [external_command, 'sudo', 'iwlist', 'enp8s0', 'scan']
            },
            "suspend": {
                1: [external_command, 'systemctl', 'suspend']
            },
            "sleep": {
                1: [external_command, 'xset', 'dpms', 'force', 'off']
            },
            "screensaver": {
                1: [external_command, 'xscreensaver-command', '-activate']
            }
        }

    def suspend(self, i3status_output_json, i3status_config):
        """
    ...
    def sleep(self, i3status_output_json, i3status_config):
        """
        Sends display to sleep
        """
        result = {
            'full_text': 'sleep',
            'name': 'sleep',
    ...
    def screensaver(self, i3status_output_json, i3status_config):
        """
